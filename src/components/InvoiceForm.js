        ...
        <Form onSubmit={this.openModal}>
          <Row>
            ...
            <Col md={4} lg={3}>
              ...
              <Link to="/">
                  <Button variant="outline-danger" className="d-block w-100 ">Cancel & Return Home</Button>
                </Link>
                <br/>
                <Button variant="outline-info" type="submit" className="d-block w-100 mb-2">Review Invoice</Button>
